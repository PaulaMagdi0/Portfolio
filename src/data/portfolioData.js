export const portfolioData = {
  hero: {
    name: "Paula Magdy",
    subtitle: "A programmer constantly seeking new learning opportunities.",
  },
  about: {
    description:
    ...
    resumeLink:
      "https://drive.google.com/file/d/1BjQiLfoLYZq17DE5DeKOZ0fSsIZiauxt/view",
  },
  projects: [
    {
      title: "BookHub",
    ...
    },
    {
      ...
      description:
        "A fun and interactive web-based game where users can play Rock, Paper, Scissors against the computer or challenge a friend. Built with HTML, CSS, and JavaScript.",
      liveLink:
